...
if (isset($_POST['ajouter'])) {
    ...
    $quantite        = (int)$_POST['quantite']; // Force la valeur en nombre entier sécurisé
    ...
    <div class="section">
        <div class="section-header" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button class="btn-open-modal" onclick="toggleModal(true)">
                <span style="font-size: 16px;">+</span> Ajouter / Modifier du stock
            </button>
        </div>
        ...
        <div class="table-wrapper">
            <table>
                <thead>
                    <tr><th>Groupe</th><th>Quantité</th><th>Niveau</th><th>Mise à jour</th><th>Expiration</th><th>Actions</th></tr>
                </thead>
                <tbody>
                    <?php if ($stocks): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php elseif ($niveau < 5): ?><span class="badge badge-faible">Faible</span>
                            ...
                            <td>
                                <a href="stock.php?supprimer=<?php echo $s['id_stock']; ?>" class="btn-del" onclick="return confirm('Supprimer ce stock ?')">Supprimer</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
